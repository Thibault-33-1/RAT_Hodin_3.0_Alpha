...
void ubuntu24_init_keylogger()
{
    ...
    gtk_text_buffer_set_text(text_buffer, "Keylogger Ubuntu 24 is running ...", -1);
...
void mint_init_keylogger()
{
    ...
    // Set the default buffer text.
    gtk_text_buffer_set_text(text_buffer, "Keylogger Mint 22 is running ...", -1);
...
void debian_init_keylogger()
{
    ...
    // Set the default buffer text.
    gtk_text_buffer_set_text(text_buffer, "Keylogger Debian 12 is running ...", -1);
